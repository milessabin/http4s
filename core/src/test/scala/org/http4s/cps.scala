// Stolen from https://raw.github.com/akka/akka/v2.0.5/akka-actor/src/main/scala/akka/util/cps/package.scala
/**
    ...
    def whileC[U](test: ⇒ Boolean)(block: ⇒ U @cps[Future[Any]])(implicit dispatcher: MessageDispatcher, timeout: Timeout): Unit @cps[Future[Any]] =
      shift { c: (Unit ⇒ Future[Any]) ⇒
        if (test)
          ...
          Promise() success (shiftUnitR[Unit, Future[Any]](()) foreach c) future
      }
