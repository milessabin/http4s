/**
 * Taken from Scalaz.  We don't think we need the rest of it for now.
 * https://github.com/scalaz/scalaz/commit/59cfba6e8e293ec24c8b610ced057e0376c13a3f#core/src/main/scala/scalaz/EphemeralStream.scala
 */
